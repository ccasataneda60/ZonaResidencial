...
public class EliminarAdministrador extends JFrame implements ActionListener{
	...
	private void crearEtiquetas() {
		...
		this.conAdmin.setText("Contrasena");
	...
	private void crearBotones() {
		...
		this.btnEliminarAdmin.setBounds(20, 210, 174, 20);
	...
	public void actionPerformed(ActionEvent e) {	
		String nombreServicio = (String) listaAdmin.getSelectedItem();
		...
		if(e.getSource()==btnEliminarAdmin){
			a.eliminarAdmin(nombreServicio);
			dao.eliminarServicioDAO(adminZon);
			EliminarAdministrador ven = new EliminarAdministrador();
